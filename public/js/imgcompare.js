! function (e) {
    e.fn.twentytwenty = function (t) {
        ...
        return this.each(function () {
            ...
            a.wrap("<div class='tk-twentytwenty-wrapper tk-twentytwenty-" + r + "'></div>"), t.no_overlay ? a.append("<div class='tk-twentytwenty-overlay tk-twentytwenty-hide'></div>") : a.append("<div class='tk-twentytwenty-overlay tk-twentytwenty-show'></div>");
            var l = a.find("img:first"),
                o = a.find("img:last");
            t.show_sep ? a.append("<div class='tk-twentytwenty-handle'></div>") : a.append("<div class='tk-twentytwenty-handle tk-twentytwenty-hide'></div>");
            var p = a.find(".tk-twentytwenty-handle");
            p.append("<span class='tk-twentytwenty-" + i + "-arrow'></span>"), p.append("<span class='tk-twentytwenty-" + s + "-arrow'></span>"), a.addClass("tk-twentytwenty-container"), l.addClass("tk-twentytwenty-before"), o.addClass("tk-twentytwenty-after"), t.show_drag || p.css("opacity", "0");
            var d = a.find(".tk-twentytwenty-overlay");
            if (t.switch_before_label) {
                var m = "<div class='tk-twentytwenty-before-label tk-twentytwenty-before-label-" + t.horbeforePos + " tk-twentytwenty-before-label-" + t.verbeforePos + "'><span>" + t.before_label + "</span></div>";
                d.append(m)
            }
            if (t.switch_after_label) {
                var c = "<div class='tk-twentytwenty-after-label  tk-twentytwenty-after-label-" + t.horafterPos + " tk-twentytwenty-after-label-" + t.verafterPos + "'><span>" + t.after_label + "</span></div>";
                d.append(c)
            }
            var w = function (t) {
                var n, i, s, d, m = (n = t, i = l.width(), s = l.height(), {
                    ...
                    c = e(a).find(".tk-twentytwenty-before-label"),
                    w = e(a).find(".tk-twentytwenty-after-label");
                if (p.css("vertical" === r ? "top" : "left", "vertical" === r ? m.ch : m.cw), "horizontal" === r) {
                    ...
                    (y = parseInt(p.css("left").replace(/px/, ""))) < f + v ? c.addClass("tk-label-hidden") : c.removeClass("tk-label-hidden"), y > h ? w.addClass("tk-label-hidden") : w.removeClass("tk-label-hidden")
                } else {
                    var y;
                    f = void 0 !== c.css("top") ? parseInt(c.css("top").replace(/px/, "")) : "",
                        v = parseInt(c.outerHeight()),
                        h = void 0 !== w.css("top") ? parseInt(w.css("top").replace(/px/, "")) : "";
                    (y = parseInt(p.css("top").replace(/px/, ""))) < f + v ? c.addClass("tk-label-hidden") : c.removeClass("tk-label-hidden"), y > h && !(h < 0) ? w.addClass("tk-label-hidden") : w.removeClass("tk-label-hidden")
                }
