;(function($, window, undefined) {
    ...
    var Tooltip = function(elm, options) {
        ...
        this.options = $.extend({
            template: '<div class="tooltip"><div class="tk-tooltip-body"><div class="tk-tooltip-content"></div><div class="tk-tooltip-callout"></div></div></div>',
    ...
    Tooltip.prototype.create = function() {
        ...
        if (self.options.contentElement) {
            ...
            var contentElement = self.element.find(".tk-tooltip-content");
        ...
        self.tooltipBody = self.tooltip.find(".tk-tooltip-content");
        ...
        self.callout = self.tooltip.find(".tk-tooltip-callout");
    };
